...
class Stock extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      stockChartYValues: [],
      text: 'MSFT',
      setSearchBar: props.searchBar ? "" : "visible"     //class for hidding search bar 
    };
  ...
  render() {
    ...
    return (
      <div className="max-w-full justify-items-stretch m-3 bg-black">
        <h1 className="ml-16 mb-4 text-lg text-white">{this.state.text}</h1>
        ...
        <div class="p-8" class={`${this.state.setSearchBar}`}>
          <div class="bg-black flex items-center rounded-full shadow-xl">
            ...
            <div class="p-4">
              <button class="bg-black text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex items-center justify-center"
